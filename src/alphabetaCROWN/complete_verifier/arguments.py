...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--mul_middle", action="store_true",
                         help="Use the 'middle' strategy for relaxation of BoundMul (sometimes gives better bounds).",
                         hierarchy=h + ["mul_middle"])
...
Globals = ReadOnlyDict({
    ...
    "lyapunov": {"c1": None, "V_lower": [], "V_upper": [], "step": 0},
    })
